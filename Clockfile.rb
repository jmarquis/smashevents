...
cron '5/20 * * * *', locals: { task: 'startgg:sync' }, overlap: false do
  rake_async('startgg:sync')
end

# Every 20 minutes (12 minute offset)
cron '12/20 * * * *', locals: { task: 'startgg:sync_past_tournaments' }, overlap: false do
